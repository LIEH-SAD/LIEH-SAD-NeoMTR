...
public class JsonPIDSPreset extends PIDSPresetBase {
    ...
    public JsonPIDSPreset(String id, String name, Identifier thumbnail, List<String> blacklist, Identifier background, String fontId, TextOverflowMode textOverflowMode, boolean[] rowHidden, boolean showClock, boolean showWeather, boolean topPadding, boolean builtin, boolean hidePlatform, int textColor) {
    ...
    public static JsonPIDSPreset parse(JsonObject rootJsonObject) {
        ...
        final Identifier background = rootJsonObject.has("background") ? Identifier.parse(rootJsonObject.get("background").getAsString()) : null;
        final Identifier thumbnail = rootJsonObject.has("thumbnail") ? Identifier.parse(rootJsonObject.get("thumbnail").getAsString()) : background;
    ...
    public void render(PIDSBlockEntity be, PoseStack poseStack, MultiBufferSource bufferSource, Level world, BlockPos pos, Direction facing, List<ScheduleEntry> arrivals, boolean[] rowHidden, float tickDelta, int x, int y, int width, int height) {
        ...
        // Draw Background
        VertexConsumer backgroundConsumer = bufferSource.getBuffer(RenderTypes.text(background));
