...
public class ScriptManager {
    ...
    private Supplier<Boolean> scriptingEnabled = () -> true;
    ...
    /**
     * Set the supplier deciding whether scripts are currently enabled.<br>
     * Scripts are still parsed when disabled, but they will not be executed until re-enabled.
     */
    public void setScriptingEnabled(Supplier<Boolean> scriptingEnabled) {
        this.scriptingEnabled = scriptingEnabled;
    }

    /**
     * @return Whether scripts may currently be executed.
     */
    public boolean isScriptingEnabled() {
        return scriptingEnabled.get();
    }
